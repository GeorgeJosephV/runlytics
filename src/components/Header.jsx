        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <div className="toggle-slider">
              <span className="toggle-label light">
